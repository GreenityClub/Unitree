...
export const listUlIcon = faListUl;
export const arrowRightIcon = faArrowRight;
export const searchIcon = faSearch;

// Add the new exclamation icons
export const exclamationIcon = faExclamation;
...
export const waterIcon = faWater;
export const soilIcon = faSeedling;
